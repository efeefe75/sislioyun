...
import com.ksp.sislioyun.firsttime.Screen_one;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        {
            Toast.makeText(this, "Bağlandı", Toast.LENGTH_SHORT).show();
        }*/
        ...
        home.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(MainActivity.this, "Ana Sayfa", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    private void showBottomSheetDialog() {
        ...
        share.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(MainActivity.this, "Paylaşmak İçin tıklandı", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        rating.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(MainActivity.this, "Puanlamak İçin tıklandı", Toast.LENGTH_SHORT).show();
            }
        });
        contact.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ...
                Toast.makeText(MainActivity.this, "İletişim İçin tıklandı", Toast.LENGTH_SHORT).show();
            }
        });
