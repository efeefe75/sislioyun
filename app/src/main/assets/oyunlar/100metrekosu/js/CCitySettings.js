function CCitySettings(){
    ...
    this.addCitiesStorage = function(){
        saveItem("100metres_RewardTaken", JSON.stringify(_aRewardTaken));
        saveItem("100metres_TimeSpent", JSON.stringify(_aTimeSpent));
        saveItem("100metres_RewardEarned", JSON.stringify(_aRewardEarned));
        saveItem("100metres_ArrivalsPosition", JSON.stringify(_aArrivalsPosition));
    };
    ...
    this.removeCitiesStorage = function(){
        ...
        removeItem("100metres_RewardTaken");
        removeItem("100metres_TimeSpent");
        removeItem("100metres_RewardEarned");
        removeItem("100metres_ArrivalsPosition");
    };
    
    this.getCitiesStorage = function(){
        _aRewardTaken = JSON.parse(getItem("100metres_RewardTaken"));
        _aTimeSpent = JSON.parse(getItem("100metres_TimeSpent"));
        _aRewardEarned = JSON.parse(getItem("100metres_RewardEarned"));
        _aArrivalsPosition = JSON.parse(getItem("100metres_ArrivalsPosition"));
    };
